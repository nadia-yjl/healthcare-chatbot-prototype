...
// Remove ToggleButtons import since we won't be using it
...
export default function ChatBox() {
  ...
  const [messages, setMessages] = useState([]); // Remove default system message
      ...
      {!isOpen ? (
        ...
        <Card style={{
          ...
          <Card.Body style={{ height: "100%", display: "flex", flexDirection: "column" }}>
            ...
            {/* Remove ToggleButtons component */}
            ...
            >
              {messages.map((msg, index) => (
                <ListGroup.Item 
                  ...
                  style={{
                    textAlign: 'left',
                    backgroundColor: msg.from === "System" ? "#f8f9fa" : "white"
                  }}
                >
                  <div style={{ display: 'flex', alignItems: 'baseline' }}>
                    <strong style={{ minWidth: '70px' }}>{`${msg.from}: `}</strong>
                    <span>{msg.body}</span>
                  </div>
                </ListGroup.Item>
              ))}
            ...
            >
              {messages.map((msg, index) => (
                <ListGroup.Item 
                  key={index}
                  style={{
                    textAlign: 'left', // Force left alignment for all messages
                    backgroundColor: msg.from === "System" ? "#f8f9fa" : "white"
                  }}
                >
                  <div style={{ display: 'flex', alignItems: 'baseline' }}>
